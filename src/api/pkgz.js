...
// 学生分班 按选课结果将学生分班 教学班下拉列表
export function qryTeachingClassList(listQuery) {
  return request({
    url: URL.qryTeachingClassList,
    params: listQuery
  })
}
// 学生分班 按选课结果将学生分班 表格列表
