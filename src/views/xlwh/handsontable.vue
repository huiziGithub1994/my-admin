  ...
  <div>
      <div v-area>
          ...
          <operation id="area-operation">
              <el-button size="small"  type="primary" plain @click="getDataBtn">数据</el-button>
          </operation>
      </div>
  ...
  data () {
    ...
    return {
      ...
      hotSettings: {
        language: 'zh-CN',
        startRows: 8,
        colWidths:calWidth(['10%','15%','15%','15%','15%','15%','15%'],document.body.clientWidth-240),
        rowHeights:50,
        ...
        fixedColumnsLeft: 1,
        maxRows:7,
        colHeaders:['姓名','学年','学期','出生年月','是否党员','创建时间','部门'],
        data:[{id:null,xn:null,xq:null,xm:null,birth:null,dy:null,time:null,bm:null}],
        columns:[
          {data:'xm'},
          {data:'xn'},
          {data:'xq'},
          ...
          {data:'time',type: 'time',timeFormat: 'k:mm:ss', correctFormat: true},
          {data:'bm',type: 'dropdown',source: function(query, callback){
            let params  = {dataStr:JSON.stringify({"currentPage":"1","pageSize":"6","t1.cur_year01":"2017","t1.cur_term01":"2"})};
  ...
  methods:{
    getTableData(){
        ...
        getStudentInfo(params).then(res =>{
            if(res.SUCCESS == 1){
              let data = [
                {id:'1',xn:'2018',xq:'2',xm:'小明',birth:'2017-09-24',dy:true,time:'19:09:00',bm:'教育资源部'},
                {id:'2',xn:'2018',xq:'2',xm:'李涛',birth:'2017-12-08',dy:true,time:'12:09:00',bm:'市场部'},
                {id:'3',xn:'2018',xq:'2',xm:'黄锋',birth:'2017-09-24',dy:false,time:'08:00:00',bm:'市场部'},
                {id:'1',xn:'2018',xq:'2',xm:'小明',birth:'2017-09-24',dy:true,time:'19:09:00',bm:'市场部'},
                {id:'2',xn:'2018',xq:'2',xm:'李涛',birth:'2017-12-08',dy:true,time:'12:09:00',bm:'市场部'},
                {id:'3',xn:'2018',xq:'2',xm:'黄锋',birth:'2017-09-24',dy:false,time:'08:00:00',bm:'市场部'},
                {id:'1',xn:'2018',xq:'2',xm:'小明',birth:'2017-09-24',dy:true,time:'19:09:00',bm:'教育资源部'}
              ];              
