...
<script>
import GradeClass from '../pkgzPt/GradeClass' // 固排禁排tab页：年级/班级禁排固排tab页组件
import Teacher from '../pkgzPt/Teacher' // 固排禁排tab页：教师禁排固排tab页组件
import TeachGroup from '../pkgzPt/TeachGroup' // 固排禁排tab页：教研组禁排tab页组件
import Course from '../pkgzPt/Course' // 固排禁排tab页：课程禁排固排tab页组件
import MergeClass from '../pkgzPt/MergeClass' // 合班设置
