  ...
  <div>
    <div v-area>
      <condition>
        ...
        <div class="condition">
          <label>学期</label>
          <selectChild v-model="search['termCode']" clearable tp="termSelect"/>
        </div>
        <div class="condition">
          <label>排课状态</label>
    ...
    <div>
      <el-table ref="singleTable" :data="tableData" :height="tableH" highlight-current-row style="width: 100%">
        ...
        <el-table-column property="termCode" label="学期" width="80px">
          <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      getPKCXListInfo(this.listQuery).then(res => {
